...
module.exports = {
    name: 'handholding',
    description: 'Kawaii Emotes: Handholding Emote',
    usage: '<@mention>',
    guildOnly: true,
    aliases: [],
    execute(message, args) {
        ...
        message.guild.fetchMember(message.client.user).then(clientMember => {
            ...
            //    return weeb_embed('pout', `**${author} is pouting, giggles~**`, message);
            //}
            return weeb_embed('handholding', `**${author} is handholding with ${usersWithCommaAnd}, so kawaii~**`, message);
