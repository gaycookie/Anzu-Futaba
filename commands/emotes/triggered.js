...
module.exports = {
    name: 'triggered',
    description: 'Kawaii Emotes: Triggered Emote',
    usage: '<@mention>',
    guildOnly: true,
    aliases: [],
    execute(message, args) {
        ...
        message.guild.fetchMember(message.client.user).then(clientMember => {
            ...
            if (!message.mentions.users.size) {
                return weeb_embed('triggered', `**${author} is triggered, ohnuu~**`, message);
            }
            return weeb_embed('triggered', `**${author} is triggered because of ${usersWithCommaAnd}, ohnuu~**`, message);
