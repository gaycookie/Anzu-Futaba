...
module.exports = {
    name: 'smile',
    description: 'Kawaii Emotes: Smile Emote',
    usage: '<@mention>',
    guildOnly: true,
    aliases: [],
    execute(message, args) {
        ...
        message.guild.fetchMember(message.client.user).then(clientMember => {
            ...
            if (!message.mentions.users.size) {
                return weeb_embed('smile', `**${author} is smiling, cutiee~**`, message);
            }
            return weeb_embed('smile', `**${author} smiles at ${usersWithCommaAnd}, cutiee~**`, message);
