...
module.exports = {
    name: 'lick',
    description: 'Kawaii Emotes: Lick Emote',
    usage: '<@mention>',
    guildOnly: true,
    ...
    execute(message, args) {
        ...
        message.guild.fetchMember(message.client.user).then(clientMember => {
            ...
            if (message.mentions.users.has(message.client.user.id)) {
                return message.channel.send(`**B-baka, you can not lick me, thats illegal!**`)
            }
            ...
            weeb_embed('lick', `**${author} is licking ${usersWithCommaAnd}, owo~**`, message);
