...
module.exports = {
    name: 'slap',
    description: 'Kawaii Emotes: slap Emote',
    usage: '<@mention>',
    guildOnly: true,
    aliases: [],
    execute(message, args) {
        ...
        message.guild.fetchMember(message.client.user).then(clientMember => {
            ...
            //    return weeb_embed('pat', `**${author} is blushing, cutie~**`, message);
            //}
            return weeb_embed('slap', `**${author} is giving ${usersWithCommaAnd} a slap, Ouchi~**`, message);
